...
const navMono = Martian_Mono({ variable: "--font-nav-mono", subsets: ["latin"], weight: "variable", display: "swap" });
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className={`${geistSans.variable} ${geistMono.variable} ${navMono.variable}`}>{children}</body></html>;
}
